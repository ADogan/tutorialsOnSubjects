...
This will create an executable jar file **TeachersEverywhere.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/TeachersEverywhere.jar

To launch the test page, open your browser at the following URL

    http://localhost:8181/TeachersEverywhere/index.html
